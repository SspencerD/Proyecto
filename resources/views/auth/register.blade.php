...
<div class="col-sm-9" id="content">
    ...
    @csrf
        ...
        <fieldset id="address">
          ...
          <div class="form-group required">
            <label for="input-zone" class="col-sm-2 control-label">Región</label>
            <div class="col-sm-10">
