    ...
    <table class="table table-hover">
      ...
      <tbody>
          ...
          <tr>
              ...
              <td class="text-center">Tapón 49/24  Extra Super Caballo loco<span class="badge badge-primary">ND</span></td></td>
                ...
                <div class="widget-content p-0">
                  <div class="widget-content-wrapper">
                    ...
                    <div class="widget-content-left flex2">
                      ...
                      <div class="widget-subheading opacity-7">Viña Concha y toro S.A</div>
                    </div>
                  </div>
                </div>
              </td>
