      ...
      <div class="row">
        ...
        <input type="text" class="form-control" readonly id="apellidoid" name="lastname" value="{{ Auth::user()->lastname }}">
              ...
              <input type="text" class="form-control" readonly id="razonid" name="raesonsocial" value="{{ Auth::user()->raesonsocial }}">
                  ...
                  <input type="text" class="form-control"  id="cargoid" name="cargo" value="{{ old('cargo') , $claim->cargo }}" placeholder="Jefa control calidad">
                  </div>
                </div>
            </fieldset> <br>
            <fieldset>
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <option value="{{ $category->id}} {{old('category',$claim->category ) }}">{{$category->name}}</option>
                @endforeach
                </select>
              </div>
        <div class="col-md-4">
